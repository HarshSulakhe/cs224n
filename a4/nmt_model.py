...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.decoder = nn.LSTMCell(input_size = 2*self.hidden_size,hidden_size = self.hidden_size,bias = True)
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        combined_outputs = torch.stack(combined_outputs,axis = 0)
        ### END YOUR CODE
